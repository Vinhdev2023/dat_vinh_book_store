    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>@if($path == '/admin/category/add-form'){{'Add Category'}}@else{{'Edit Category'}}@endif</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">@if($path == '/admin/category/add-form'){{'Add Category'}}@else{{'Edit Category'}}@endif</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card card-default">
                    ...
                    <!-- /.card-header -->
                    <form action="@if($path == '/admin/category/add-form'){{'/admin/category/add'}}@else{{'/admin/category/update/'.$category[0]->id}}@endif" method="post">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Category name</label>
                                <input type="text" name="CategoryName" @if(@isset($category))value="{{$category[0]->name}}"@endif class="form-control" id="exampleInputEmail1" placeholder="Enter category name">
                            </div>
                        </div>
                        <!-- /.card-body -->
