                    ...
                    <div class="col-12">
                        <div class="card">
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    @foreach ($publishers as $obj)
                                        <tr>
                                            <td>{{$obj->name}}</td>
                                            <td>
                                                <a href="/admin/publisher/edit-form/{{$obj->id}}" class="btn btn-primary">Edit</a>
                                                <a href="/admin/publisher/delete/{{$obj->id}}" onclick="return confirm('You want to delete?')" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                            ...
                            <div class="card-footer">
                                <a href="/admin/publisher/add-form" class="btn btn-primary">Add a new publisher</a>
                            </div>
                        </div>
                        <!-- /.card -->
                    </div>
