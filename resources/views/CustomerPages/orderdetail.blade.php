            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="tg-sectionhead">
                            '<h2><span>Status:</span>{{$order->status}} @if($order->status == 'PENDING')<a href="/order/status/CANCELED/{{$order->id}}" class="btn btn-danger">Cancel</a>  <a href="/order/update-form/{{$order->id}}" class="btn btn-warning">Repair</a>@endif</h2>
                        </div>
                        <div class="tg-sectionhead">
